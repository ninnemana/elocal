...
var stepDisplay;
var myRoute; // Directions JSON result
...
$(document).ready(function () {
    ...
    $('.show_text_directions').live('click', function () {
        $(this).fadeOut();
        showTextDirections();
    });

    $('.show_map_directions').live('click', function () {
        $(this).fadeOut();
        displayMap();
    });
    ...
    $('#btnSubmit').live('click', function () {
        ...
        $('.show_text_directions').css('display', 'block');
    });
...
function showTextDirections() {
    // We're going to hide the map and display text directions.
    $('#text_directions').remove();
    var html = "<div id='text_directions'>";
    $.each(myRoute.steps, function (i, step) {
        html += '<div class="text_direction">';
        html += '<span class="desc">' + step.instructions + '</span>';
        html += '<div>';
        html += '<span class="distance">' + step.distance.text + '</span>';
    ...
    $('#map').fadeOut();
    $('#map').after(html);
    $('.show_map_directions').css('display', 'block');
}
